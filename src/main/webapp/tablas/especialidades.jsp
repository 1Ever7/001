...
<html>
    ...
    <body>
        ...
        <table class="styled-table ">
            ...
            <tbody>
                <c:forEach var="especies" items="${especies}">
                    <tr>
                        <td>${especies.id}</td>
                        <td>${especies.nombre}</td>
                        <td>
                            <form action="MainServlet4?action=ver" method="post">
                                <input type="hidden" name="action" value="ver">
                                <input type="hidden" name="id" value="${especies.id}">
                                <button type="submit" class="styled-button editar-button">Editar</button>
                            </form>
                            <form action="MainServlet4?action=select" method="post">
        ...
        <form action="CRUDespe/AÑADIR.jsp" method="post">
            <input type="hidden" name="action" value="insertar">
            <button type="submit" class="styled-button agregar-button">Agregar Especialidad</button>
        </form>
    </body>
</html>
